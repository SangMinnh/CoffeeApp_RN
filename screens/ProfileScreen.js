    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.userInfoSection}>
        <View style={{ flexDirection: 'row', marginTop: 15 }}>
          ...
          <View style={{ marginLeft: 20 }}>
            ...
            <Caption style={styles.caption}>@sangminh</Caption>
          </View>
        </View>
      </View>
      ...
      <View style={styles.userInfoSection}>
        <View style={styles.row}>
          ...
          <Text style={{ color: "#777777", marginLeft: 20 }}>Ho Chi Minh City, VietNam</Text>
        </View>
        <View style={styles.row}>
          <Icon name="phone" color="#777777" size={20} />
          <Text style={{ color: "#777777", marginLeft: 20 }}>+84942850506</Text>
        </View>
        <View style={styles.row}>
          <Icon name="email" color="#777777" size={20} />
          <Text style={{ color: "#777777", marginLeft: 20 }}>angelmaster49@gmail.com</Text>
        </View>
      </View>
